...
options.maxIter = 2;	  % Maximum number of iterations of L-BFGS to run 
options.display = 'on';
...
%----------------------------------------------------------------------------
% [cost, grad] = softmaxCost(saeSoftmaxTheta, numClasses, hiddenSizeL2, lambda, ...
%                                    sae2Features, trainLabels);
% 
% % Check that the numerical and analytic gradients are the same
% numgrad = computeNumericalGradient( @(x) softmaxCost(x, numClasses, hiddenSizeL2, lambda, ...
%                                    sae2Features, trainLabels), ...
%                                        saeSoftmaxTheta);
% 
